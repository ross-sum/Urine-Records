...
.load ./fileio.so
UPDATE ColourChart SET Image=readfile('1.png') WHERE Value=570;
UPDATE ColourChart SET Image=readfile('2.png') WHERE Value=573;
UPDATE ColourChart SET Image=readfile('3.png') WHERE Value=575;
UPDATE ColourChart SET Image=readfile('4.png') WHERE Value=580;
UPDATE ColourChart SET Image=readfile('5.png') WHERE Value=585;
UPDATE ColourChart SET Image=readfile('6.png') WHERE Value=590;
UPDATE ColourChart SET Image=readfile('7.png') WHERE Value=595;
UPDATE ColourChart SET Image=readfile('8.png') WHERE Value=600;
UPDATE ColourChart SET Image=readfile('9.png') WHERE Value=605;
UPDATE ColourChart SET Image=readfile('10.png') WHERE Value=610;
UPDATE ColourChart SET Image=readfile('11.png') WHERE Value=615;
UPDATE ColourChart SET Image=readfile('12.png') WHERE Value=620;
UPDATE ColourChart SET Image=readfile('13.png') WHERE Value=625;
UPDATE ColourChart SET Image=readfile('14.png') WHERE Value=630;
UPDATE ColourChart SET Image=readfile('15.png') WHERE Value=635;
UPDATE ColourChart SET Image=readfile('16.png') WHERE Value=640;
